...
(1, 'admin', 'admin@admin.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef');
...
ALTER TABLE `urls`
  ...
  ADD CONSTRAINT `urls_ibfk_3` FOREIGN KEY (`url_comm`) REFERENCES `commentor` (`comm_id`);
